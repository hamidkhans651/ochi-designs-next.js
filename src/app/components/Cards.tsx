    ...
    <div className='w-full h-screen bg-zinc-900 flex items-center px-10  py-10 gap-5 '>
      <div className='cardcontaine flex gap-5 w-full h-[60vh] grid grid-cols-1 md:grid-cols-3'>
        <div className='card relative rounded-xl w-full h-full bg-[#004D43] flex items-center justify-center'>
          <img className='w-32 md:w-48' src="https://ochi.design/wp-content/uploads/2022/04/logo001.svg" alt="" />
        ...
        <div className='card relative rounded-xl w-full h-full bg-[#212121] flex items-center justify-center '>
          <img className='w-32 md:w-48' src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
        ...
        <div className='card relative rounded-xl w-full h-full bg-[#212121]  flex items-center justify-center '>
          <img className='w-32 md:w-48' src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
